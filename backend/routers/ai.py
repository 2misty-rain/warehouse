...
def ai_suggestions(db: Session = Depends(get_db)):
    ...
    suggestions.append({"text": "设备 CAA241100001 给某客户试用了，预计下周五还回", "type": "operation"})
    suggestions.append({"text": "设备 CAA241100002 的物联网卡开卡了", "type": "operation"})
